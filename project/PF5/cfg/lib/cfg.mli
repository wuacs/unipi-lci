...
val translate_miniimp: ImpAst.program -> ImpAst.miniimp_simple control_flow_graph

val miniimp_cfg_to_minirisc: ImpAst.miniimp_simple control_flow_graph -> Minirisc.scomm control_flow_graph
