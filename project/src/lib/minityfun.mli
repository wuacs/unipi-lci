...
returns {b None} if the program contain a syntax error, otherwise returning the AST.
...
(**
Takes a string representing a filepath  of a MiniTyFun program
and returns a pair of {!Minityfun_ast.value} and {!Minityfun.tau} representing 
the normal form of the program and its type.
*)

val eval: ast -> value
(**
This function simply evaluates the MiniTyFun represented by this {!Minityfun_ast.ast}
*)